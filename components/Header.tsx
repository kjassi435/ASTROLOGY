      ...
      >
        <div className="max-w-[1280px] mx-auto px-6 flex items-center justify-between gap-6 h-[72px]">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <img src="/images/logo.png" alt="Arvin Astro" style={{ width: 65, height: 65, objectFit: "contain" }} className="transition-transform group-hover:scale-105" />
          </Link>
        ...
        >
          <div className="flex items-center gap-2.5 px-6 h-[72px] border-b border-muted">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/logo.png" alt="Arvin Astro" style={{ width: 61, height: 61, objectFit: "contain" }} />
